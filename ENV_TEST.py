...
class Retail_Environment (object):
	...
	def __init__(self, lifetime, leadtime, mean_demand, coef_of_var, max_order, cost_order, cost_outdate, cost_lost, cost_holding, FIFO, LIFO, time, warmup):
	...
	def render(self):
		...
		for i in range(0, self.leadtime):
